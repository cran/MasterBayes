...
%<<echo=true>>=
%res1<-expression(varPed(x="terr",gender="Female",relational="OFFSPRING",restrict=TRUE))  
%@
...
%# 50 unrealted parent-offspring trios
...
%res1<-expression(varPed(x="offspring", restrict=0))
%res2<-expression(varPed(x="year", relational="OFFSPRING", restrict=TRUE))
