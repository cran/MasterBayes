...
\begin{figure}[!h]
\begin{center}
\includegraphics[height=2cm, width=2cm]{r}
\end{center}
\end{figure}
...
\begin{figure}[!h]
\begin{center}
\includegraphics{MasterBayesActive2-006}
\end{center}
...
\begin{figure}[!h]
\begin{center}
\includegraphics{MasterBayesActive2-007}
\end{center}
...
\begin{figure}[!h]
\begin{center}
\includegraphics{MasterBayesActive2-008}
\end{center}
...
\begin{figure}[!h]
\begin{center}
\includegraphics{MasterBayesActive2-009}
\end{center}
...
\begin{figure}[!h]
\begin{center}
\includegraphics{MasterBayesActive2-022}
\end{center}
...
\begin{figure}[!h]
\begin{center}
\includegraphics{MasterBayesActive2-027}
\end{center}
...
\begin{figure}[!h]
\begin{center}
\includegraphics{MasterBayesActive2-030}
\end{center}
...
\begin{figure}[!h]
\begin{center}
\includegraphics{MasterBayesActive2-035}
\end{center}
...
> model6 <- MCMCped(PdP = PdP, GdP = GdP, pP = pP,
+     tP = tunePed(USsire = 0.1), verbose = FALSE)
> # reduce MH tuning parameter because prior reduces 
> # posterior varaince
> plot(model6$USsire)
\end{Sinput}
\end{Schunk}
...
\begin{figure}[!h]
\begin{center}
\includegraphics{MasterBayesActive2-039}
\end{center}
...
\begin{figure}[!h]
\begin{center}
\includegraphics{MasterBayesActive2-044}
\end{center}
...
\begin{figure}[!h]
\begin{center}
\includegraphics{MasterBayesActive2-047}
\end{center}
...
\begin{figure}[!h]
\begin{center}
\includegraphics{MasterBayesActive2-050}
\end{center}
...
>
> PdP <- PdataPed(formula = list(res1, var1, var2,
+     list(var1, var2)), data = data_INT)
>
> simped <- simpedigree(PdP, beta = c(0.5, 10, -1))
> # simulate pedigree with old.slope (0.5)
> # difference between old and young when size = 0 (10)
> # difference between old and young slopes = -1
>
> G <- simgenotypes(A = A, E1 = 0.005, E2 = 0.005, 
+     ped = simped$ped, no_dup = 1)
> GdP <- GdataPed(G = G$Gobs, id = G$id)
>
> model.INT <- MCMCped(PdP = PdP, GdP = GdP, mm.tol = 1,
+     verbose = FALSE)
\end{Sinput}
\end{Schunk}
...
\begin{figure}[!h]
\begin{center}
\includegraphics{MasterBayesActive2-057}
\end{center}
...
\begin{figure}[!h]
\begin{center}
\includegraphics{MasterBayesActive2-060}
\end{center}
...
\begin{figure}[!h]
\begin{center}
\includegraphics{MasterBayesActive2-063}
\end{center}
...
> # 100 offspring, with 4 on each of 25 territories
> 
>
...
> res1 <- expression(varPed(x = "terr", gender = "Female", 
+      relational = "OFFSPRING", restrict = "=="))
> var1 <- expression(varPed(x = "terr", gender = "Male", 
+      relational = "OFFSPRING"))
...
>
> EPP<-0.2
> beta <- (1-EPP)/(1-EPP + (EPP/49))
> # within-pair paternity rate = 0.8
>
> simped <- simpedigree(PdP, beta = logit(beta))
> G <- simgenotypes(A = A, E1 = 0.01, E2 = 0.01, ped = simped$ped, 
+     no_dup = 1)
> GdP <- GdataPed(G = G$Gobs, id = G$id)
> # simuate pedigree and genotypes
>
> rm_males <- 1:25
...
+     x[-rm_males]
+ }), id = G$id[-rm_males])
> # remove the genotype and phenotype records of the 25
> # males that were on the unsampled territories
\end{Sinput}
\end{Schunk}
...
> model.miss <- MCMCped(PdP = PdP_miss, GdP = GdP_miss, 
+     verbose = FALSE)
...
\begin{figure}[!h]
\begin{center}
\includegraphics{MasterBayesActive2-068}
\end{center}
...
\begin{figure}[!h]
\begin{center}
\includegraphics{MasterBayesActive2-070}
\end{center}
...
> NW <- 1
> NE <- 24
> #  The model treated sampled and unsampled as
> # equivalent so no need to deal with the unsampled
>
...
\begin{figure}[!h]
\begin{center}
\includegraphics{MasterBayesActive2-073}
\end{center}
...
\begin{figure}[!h]
\begin{center}
\includegraphics{MasterBayesActive2-076}
\end{center}
...
\begin{figure}[!h]
\begin{center}
\includegraphics{MasterBayesActive2-078}
\end{center}
...
\begin{figure}[!h]
\begin{center}
\includegraphics{MasterBayesActive2-081}
\end{center}
...
\begin{figure}[!h]
\begin{center}
\includegraphics{MasterBayesActive2-084}
\end{center}
...
\begin{figure}[!h]
\begin{center}
\includegraphics{MasterBayesActive2-087}
\end{center}
...
\begin{figure}[!h]
\begin{center}
\includegraphics{MasterBayesActive2-090}
\end{center}
...
\begin{figure}[!h]
\begin{center}
\includegraphics[height=8.5cm]{MasterBayesActive2-093}
\end{center}
...
\begin{figure}[!h]
\begin{center}
\includegraphics{MasterBayesActive2-096}
\end{center}
...
\begin{figure}[!h]
\begin{center}
\includegraphics{MasterBayesActive2-099}
\end{center}
