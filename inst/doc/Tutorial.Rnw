...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
    ...
    -0.0710401      0.0096006      0.0003036      0.0002799 

2. Quantiles for each variable:

    2.5%      25%      50%      75%    97.5% 
-0.08935 -0.07767 -0.07071 -0.06413 -0.05329 
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
          ...
          Mean             SD       Naive SE Time-series SE 
    -0.2549019      0.0294576      0.0009315      0.0012296 

2. Quantiles for each variable:

   2.5%     25%     50%     75%   97.5% 
-0.3136 -0.2755 -0.2536 -0.2354 -0.1985 
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
          ...
          Mean             SD       Naive SE Time-series SE 
       34.7073        15.3054         0.4840         0.4942 

2. Quantiles for each variable:

 2.5%   25%   50%   75% 97.5% 
12.60 24.04 32.58 42.45 71.81 
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
          ...
          Mean             SD       Naive SE Time-series SE 
     0.0898335      0.0098633      0.0003119      0.0003024 

2. Quantiles for each variable:

   2.5%     25%     50%     75%   97.5% 
0.07080 0.08310 0.08982 0.09632 0.10907 
\end{Soutput}
\begin{Sinput}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
          ...
          Mean             SD       Naive SE Time-series SE 
     5.668e-03      2.470e-03      7.811e-05      9.525e-05 

2. Quantiles for each variable:

    2.5%      25%      50%      75%    97.5% 
0.001735 0.003957 0.005295 0.007077 0.011709 
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
          ...
          Mean             SD       Naive SE Time-series SE 
     0.1037264      0.0118089      0.0003734      0.0004673 

2. Quantiles for each variable:

   2.5%     25%     50%     75%   97.5% 
0.08205 0.09569 0.10377 0.11110 0.12867 
\end{Soutput}
\begin{Sinput}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
          ...
          Mean             SD       Naive SE Time-series SE 
     0.0135093      0.0084078      0.0002659      0.0007991 

2. Quantiles for each variable:

     2.5%       25%       50%       75%     97.5% 
0.0003110 0.0070913 0.0123920 0.0193278 0.0320368 
\end{Soutput}
\begin{Sinput}
> plot(model.pedE$E2)
\end{Sinput}
...
\begin{Soutput}
             Mean        SD
size.D  0.8922474 0.1565087
size.S -0.9246049 0.1618438
\end{Soutput}
\begin{Sinput}
...
\begin{Soutput}
             Mean        SD
size.D  0.8982264 0.1633869
size.S -0.9282619 0.1595877
\end{Soutput}
\begin{Sinput}
...
\begin{Soutput}
             Mean        SD
size.D  0.8898482 0.1513140
size.S -0.9299088 0.1564644
\end{Soutput}
\end{Schunk}
...
-2.2946  -0.9925  -0.4696   0.7230   2.0003  

Coefficients:
            Estimate Std. Error z value Pr(>|z|)    
(Intercept)  -9.5336     1.5565  -6.125 9.07e-10 ***
size[1:50]    0.9214     0.1439   6.405 1.50e-10 ***
---
Signif. codes:  0 `***' 0.001 `**' 0.01 `*' 0.05 `.' 0.1 ` ' 1 

(Dispersion parameter for poisson family taken to be 1)

    Null deviance: 94.348  on 49  degrees of freedom
Residual deviance: 54.892  on 48  degrees of freedom
AIC: 120.49
...
Lag 0  -0.68242977 -0.993256391     1.00000000
Lag 1  -0.23577641 -0.387093413     0.39191319
Lag 5  -0.01037097 -0.070035562     0.07279582
Lag 10 -0.03487188 -0.090519773     0.09793540
Lag 50  0.02974966  0.005816045    -0.00543799
\end{Soutput}
\end{Schunk}
...
\begin{Soutput}
               size    age.young size.age.young
Lag 0  -0.627369602  0.139492847     1.00000000
Lag 1  -0.230835232  0.085810138     0.40930631
Lag 5   0.007644189  0.038344554     0.02487925
Lag 10 -0.025581392 -0.002057356     0.01047248
Lag 50 -0.003223925 -0.008117984    -0.02397435
\end{Soutput}
\end{Schunk}
...
Deviance Residuals: 
    Min       1Q   Median       3Q      Max  
-2.5268  -1.1110  -0.1683   0.4556   2.4151  

Coefficients:
                      Estimate Std. Error z value Pr(>|z|)    
(Intercept)           -0.18638    0.16559  -1.126  0.26035    
par_ageyoung          -0.04855    0.23900  -0.203  0.83903    
par_size               0.47874    0.14022   3.414  0.00064 ***
par_ageyoung:par_size -1.12593    0.20466  -5.501 3.77e-08 ***
---
Signif. codes:  0 `***' 0.001 `**' 0.01 `*' 0.05 `.' 0.1 ` ' 1 

(Dispersion parameter for poisson family taken to be 1)

    Null deviance: 138.88  on 99  degrees of freedom
Residual deviance: 108.60  on 96  degrees of freedom
AIC: 254.96
