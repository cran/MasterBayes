...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
    ...
    -0.0534434      0.0080268      0.0002538      0.0002379 

2. Quantiles for each variable:

    2.5%      25%      50%      75%    97.5% 
-0.06966 -0.05880 -0.05334 -0.04770 -0.03802 
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
          ...
          Mean             SD       Naive SE Time-series SE 
    -0.2336037      0.0293521      0.0009282      0.0014290 

2. Quantiles for each variable:

   2.5%     25%     50%     75%   97.5% 
-0.2949 -0.2524 -0.2323 -0.2132 -0.1824 
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
          ...
          Mean             SD       Naive SE Time-series SE 
       33.3913        14.0652         0.4448         0.5226 

2. Quantiles for each variable:

 2.5%   25%   50%   75% 97.5% 
11.85 23.05 31.15 41.15 66.74 
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
          ...
          Mean             SD       Naive SE Time-series SE 
     0.0998886      0.0105240      0.0003328      0.0003400 

2. Quantiles for each variable:

   2.5%     25%     50%     75%   97.5% 
0.08107 0.09252 0.09903 0.10686 0.12090 
\end{Soutput}
\begin{Sinput}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
          ...
          Mean             SD       Naive SE Time-series SE 
     8.776e-03      2.970e-03      9.392e-05      1.244e-04 

2. Quantiles for each variable:

    2.5%      25%      50%      75%    97.5% 
0.003722 0.006646 0.008555 0.010663 0.014821 
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
          ...
          Mean             SD       Naive SE Time-series SE 
     0.1252940      0.0133647      0.0004226      0.0005738 

2. Quantiles for each variable:

   2.5%     25%     50%     75%   97.5% 
0.09846 0.11651 0.12515 0.13396 0.15204 
\end{Soutput}
\begin{Sinput}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
          ...
          Mean             SD       Naive SE Time-series SE 
     0.0132305      0.0075319      0.0002382      0.0006749 

2. Quantiles for each variable:

    2.5%      25%      50%      75%    97.5% 
0.001116 0.007896 0.012297 0.017785 0.030465 
\end{Soutput}
\begin{Sinput}
> plot(model.pedE$E2)
\end{Sinput}
...
\begin{Soutput}
             Mean        SD
size.D  1.3223785 0.2170615
size.S -0.9435895 0.1614431
\end{Soutput}
\begin{Sinput}
...
\begin{Soutput}
             Mean        SD
size.D  1.3161295 0.2253079
size.S -0.9386415 0.1598695
\end{Soutput}
\begin{Sinput}
...
\begin{Soutput}
             Mean        SD
size.D  1.2845238 0.2017242
size.S -0.9411962 0.1572764
\end{Soutput}
\end{Schunk}
...
\begin{Soutput}
             Mean        SD
size.D  1.2616248 0.2027634
size.S -0.9330864 0.1585476
\end{Soutput}
\begin{Sinput}
...
-1.4474  -0.7415  -0.3811   0.4774   1.8707  

Coefficients:
            Estimate Std. Error z value Pr(>|z|)    
(Intercept)  -12.393      1.775  -6.982 2.91e-12 ***
size[1:50]     1.159      0.157   7.387 1.51e-13 ***
---
Signif. codes:  0 `***' 0.001 `**' 0.01 `*' 0.05 `.' 0.1 ` ' 1 

(Dispersion parameter for poisson family taken to be 1)

    Null deviance: 104.73  on 49  degrees of freedom
Residual deviance:  37.06  on 48  degrees of freedom
AIC: 99.127
...
Lag 0  -0.6967549813 -0.99097194     1.00000000
Lag 1  -0.1190755988 -0.24880428     0.26430478
Lag 5   0.0007159008 -0.05548494     0.06180209
Lag 10 -0.0380808563 -0.05414043     0.05305653
Lag 50 -0.0224961265 -0.05080229     0.05322268
\end{Soutput}
\end{Schunk}
...
\begin{Soutput}
                size  age.young size.age.young
Lag 0  -0.6670727717 0.34466912     1.00000000
Lag 1  -0.2273120513 0.18759154     0.38570038
Lag 5  -0.0000721773 0.05366713     0.08045415
Lag 10  0.0389550299 0.11401119     0.05847653
Lag 50  0.0029256667 0.04242018     0.05117598
\end{Soutput}
\end{Schunk}
...
Deviance Residuals: 
    Min       1Q   Median       3Q      Max  
-2.2784  -1.0205  -0.3433   0.5728   1.8292  

Coefficients:
                      Estimate Std. Error z value Pr(>|z|)    
(Intercept)            -0.1211     0.1582  -0.765 0.443980    
par_ageyoung           -0.2105     0.2430  -0.866 0.386400    
par_size                0.5163     0.1345   3.840 0.000123 ***
par_ageyoung:par_size  -1.1135     0.1843  -6.043 1.51e-09 ***
---
Signif. codes:  0 `***' 0.001 `**' 0.01 `*' 0.05 `.' 0.1 ` ' 1 

(Dispersion parameter for poisson family taken to be 1)

    Null deviance: 137.78  on 99  degrees of freedom
Residual deviance:  99.68  on 96  degrees of freedom
AIC: 244.19
