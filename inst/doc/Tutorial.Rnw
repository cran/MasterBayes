...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
    ...
    -0.0539791      0.0080652      0.0002550      0.0002822 

2. Quantiles for each variable:

    2.5%      25%      50%      75%    97.5% 
-0.07059 -0.05918 -0.05398 -0.04827 -0.03982 
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
          ...
          Mean             SD       Naive SE Time-series SE 
    -0.2384179      0.0302981      0.0009581      0.0016025 

2. Quantiles for each variable:

   2.5%     25%     50%     75%   97.5% 
-0.3047 -0.2571 -0.2364 -0.2168 -0.1850 
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
          ...
          Mean             SD       Naive SE Time-series SE 
       33.7145        15.0501         0.4759         0.5410 

2. Quantiles for each variable:

 2.5%   25%   50%   75% 97.5% 
11.76 23.29 31.33 41.50 69.72 
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
          ...
          Mean             SD       Naive SE Time-series SE 
     0.0887159      0.0096288      0.0003045      0.0003308 

2. Quantiles for each variable:

   2.5%     25%     50%     75%   97.5% 
0.07013 0.08200 0.08855 0.09524 0.10735 
\end{Soutput}
\begin{Sinput}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
          ...
          Mean             SD       Naive SE Time-series SE 
     0.0075755      0.0031373      0.0000992      0.0001500 

2. Quantiles for each variable:

    2.5%      25%      50%      75%    97.5% 
0.002531 0.005313 0.007202 0.009458 0.014986 
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
          ...
          Mean             SD       Naive SE Time-series SE 
     0.0745659      0.0108133      0.0003419      0.0003470 

2. Quantiles for each variable:

   2.5%     25%     50%     75%   97.5% 
0.05510 0.06701 0.07384 0.08158 0.09711 
\end{Soutput}
\begin{Sinput}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
          ...
          Mean             SD       Naive SE Time-series SE 
     0.0030745      0.0029441      0.0000931      0.0001692 

2. Quantiles for each variable:

     2.5%       25%       50%       75%     97.5% 
6.632e-05 9.752e-04 2.228e-03 4.327e-03 1.064e-02 
\end{Soutput}
\begin{Sinput}
> plot(model.pedE$E2)
\end{Sinput}
...
> size <- rnorm(150, 10)
> data.MM <- as.data.frame(list(id = 1:150, sex = sex, offspring = offspring, size = size))
...
\begin{Soutput}
             Mean        SD
size.D  0.8704854 0.1749540
size.S -1.1587299 0.1705104
\end{Soutput}
\begin{Sinput}
...
\begin{Soutput}
            Mean        SD
size.D  0.873614 0.1716659
size.S -1.210798 0.1710248
\end{Soutput}
\begin{Sinput}
...
\begin{Soutput}
            Mean        SD
size.D  0.840978 0.1701362
size.S -1.208325 0.1723819
\end{Soutput}
\end{Schunk}
...
\begin{Soutput}
             Mean        SD
size.D  0.8623071 0.1654108
size.S -1.2071492 0.1738680
\end{Soutput}
\begin{Sinput}
...
-1.6272  -0.9670  -0.5573   0.1248   3.6667  

Coefficients:
            Estimate Std. Error z value Pr(>|z|)    
(Intercept)  -9.1920     1.7209  -5.341 9.23e-08 ***
size[1:50]    0.8982     0.1619   5.548 2.89e-08 ***
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1 

(Dispersion parameter for poisson family taken to be 1)

    Null deviance: 90.10  on 49  degrees of freedom
Residual deviance: 57.81  on 48  degrees of freedom
AIC: 123.09
...
Lag 0  -0.61576648 -0.994094306    1.000000000
Lag 1  -0.20308996 -0.364969640    0.365537679
Lag 5  -0.05647493 -0.088645796    0.093996120
Lag 10  0.03473510 -0.019660411    0.017188461
Lag 50 -0.03403096 -0.006717241    0.004001981
\end{Soutput}
\end{Schunk}
...
\begin{Soutput}
              size   age.young size.age.young
Lag 0  -0.63471307  0.15832853    1.000000000
Lag 1  -0.23301757  0.06076566    0.334028539
Lag 5  -0.02530118  0.04681907    0.068662114
Lag 10  0.01300251  0.03053844   -0.019981624
Lag 50 -0.01894546 -0.01420772    0.004566597
\end{Soutput}
\end{Schunk}
...
Deviance Residuals: 
     Min        1Q    Median        3Q       Max  
-1.92188  -1.19467  -0.06756   0.52728   2.50632  

Coefficients:
                      Estimate Std. Error z value Pr(>|z|)    
(Intercept)            0.02234    0.14601   0.153  0.87838    
par_ageyoung          -0.29789    0.22456  -1.327  0.18465    
par_size               0.44566    0.13319   3.346  0.00082 ***
par_ageyoung:par_size -0.90375    0.20319  -4.448 8.67e-06 ***
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1 

(Dispersion parameter for poisson family taken to be 1)

    Null deviance: 127.23  on 99  degrees of freedom
Residual deviance: 105.30  on 96  degrees of freedom
AIC: 254.36
...
> data_EPP <- as.data.frame(list(id = 1:175, sex = sex, offspring = offspring, terr = terr))
> res1 <- expression(varPed(x = "terr", gender = "Female", relational = "OFFSPRING", restrict = "=="))
...
\begin{Schunk}
\begin{Sinput}
> PdP_miss <- PdataPed(formula = list(res1, var1, res2), data = data_EPP_miss, USsire = TRUE)
...
\begin{Schunk}
\begin{Sinput}
> var2 <- expression(varPed(x = "terr", gender = "Male", relational = "OFFSPRING", USvar = FALSE))
> PdP_miss2 <- PdataPed(formula = list(res1, var2, res2), data = data_EPP_miss, USsire = TRUE)
> model.miss2 <- MCMCped(PdP = PdP_miss2, GdP = GdP_miss, pP = pP, verbose = FALSE)
...
\begin{Schunk}
\begin{Sinput}
> var3 <- expression(varPed(x = "terr", gender = "Male", relational = "OFFSPRING", USvar = FALSE, merge = TRUE))
> PdP_miss3 <- PdataPed(formula = list(res1, var3, res2), data = data_EPP_miss, USsire = TRUE)
> model.miss3 <- MCMCped(PdP = PdP_miss3, GdP = GdP_miss, pP = pP, verbose = FALSE)
