...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
    ...
    -0.0705084      0.0096646      0.0003056      0.0003687 

2. Quantiles for each variable:

    2.5%      25%      50%      75%    97.5% 
-0.09027 -0.07708 -0.07031 -0.06392 -0.05222 
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
          ...
          Mean             SD       Naive SE Time-series SE 
    -0.2561402      0.0308847      0.0009767      0.0015460 

2. Quantiles for each variable:

   2.5%     25%     50%     75%   97.5% 
-0.3217 -0.2762 -0.2543 -0.2345 -0.1968 
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
          ...
          Mean             SD       Naive SE Time-series SE 
       36.4489        15.3089         0.4841         0.4888 

2. Quantiles for each variable:

 2.5%   25%   50%   75% 97.5% 
13.84 25.05 34.36 45.23 71.89 
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
          ...
          Mean             SD       Naive SE Time-series SE 
     0.1113245      0.0106874      0.0003380      0.0003598 

2. Quantiles for each variable:

   2.5%     25%     50%     75%   97.5% 
0.09247 0.10388 0.11098 0.11806 0.13428 
\end{Soutput}
\begin{Sinput}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
          ...
          Mean             SD       Naive SE Time-series SE 
     3.139e-03      2.045e-03      6.468e-05      8.843e-05 

2. Quantiles for each variable:

     2.5%       25%       50%       75%     97.5% 
0.0004436 0.0015502 0.0027150 0.0042664 0.0081121 
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
          ...
          Mean             SD       Naive SE Time-series SE 
     0.0823078      0.0115562      0.0003654      0.0003850 

2. Quantiles for each variable:

   2.5%     25%     50%     75%   97.5% 
0.06121 0.07416 0.08183 0.08950 0.10637 
\end{Soutput}
\begin{Sinput}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
          ...
          Mean             SD       Naive SE Time-series SE 
     0.0099482      0.0054730      0.0001731      0.0003909 

2. Quantiles for each variable:

    2.5%      25%      50%      75%    97.5% 
0.001346 0.005836 0.009376 0.013489 0.022430 
\end{Soutput}
\begin{Sinput}
> plot(model.pedE$E2)
\end{Sinput}
...
\begin{Soutput}
            Mean        SD
size.D  0.906408 0.1148980
size.S -1.055716 0.1346631
\end{Soutput}
\begin{Sinput}
...
\begin{Soutput}
            Mean        SD
size.D  0.917387 0.1246951
size.S -1.057533 0.1330367
\end{Soutput}
\begin{Sinput}
...
\begin{Soutput}
             Mean        SD
size.D  0.8759533 0.1216854
size.S -1.0475618 0.1449654
\end{Soutput}
\end{Schunk}
...
-1.8622  -0.8596  -0.5631   0.5831   2.1162  

Coefficients:
            Estimate Std. Error z value Pr(>|z|)    
(Intercept) -10.1811     1.2723  -8.002 1.22e-15 ***
size[1:50]    0.9585     0.1110   8.639  < 2e-16 ***
---
Signif. codes:  0 `***' 0.001 `**' 0.01 `*' 0.05 `.' 0.1 ` ' 1 

(Dispersion parameter for poisson family taken to be 1)

    Null deviance: 124.67  on 49  degrees of freedom
Residual deviance:  50.44  on 48  degrees of freedom
AIC: 104.75
...
Lag 0  -0.723880547 -0.993535878     1.00000000
Lag 1  -0.292813152 -0.360300022     0.36308792
Lag 5  -0.018250690 -0.048076477     0.05390591
Lag 10 -0.015056619 -0.026561457     0.02779523
Lag 50  0.001421839 -0.006510896     0.00999676
\end{Soutput}
\end{Schunk}
...
\begin{Soutput}
              size   age.young size.age.young
Lag 0  -0.67913586 -0.24136695     1.00000000
Lag 1  -0.23960823 -0.10187419     0.33944642
Lag 5  -0.06560018 -0.03704573     0.05246377
Lag 10 -0.05099154 -0.00323123     0.07692695
Lag 50 -0.04015291 -0.03958790     0.01360141
\end{Soutput}
\end{Schunk}
...
Deviance Residuals: 
    Min       1Q   Median       3Q      Max  
-1.7875  -1.1179  -0.1102   0.3172   2.8312  

Coefficients:
                      Estimate Std. Error z value Pr(>|z|)    
(Intercept)            -0.3347     0.1849  -1.810   0.0703 .  
par_ageyoung            0.2283     0.2438   0.936   0.3490    
par_size                0.5360     0.1259   4.258 2.07e-05 ***
par_ageyoung:par_size  -0.8752     0.1861  -4.702 2.57e-06 ***
---
Signif. codes:  0 `***' 0.001 `**' 0.01 `*' 0.05 `.' 0.1 ` ' 1 

(Dispersion parameter for poisson family taken to be 1)

    Null deviance: 133.33  on 99  degrees of freedom
Residual deviance: 109.04  on 96  degrees of freedom
AIC: 257.96
